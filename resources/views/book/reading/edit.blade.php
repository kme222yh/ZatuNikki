<x-app-layout>
    ...
    <form action="{{ route('book.reading.edit', ['reading'=>$reading]) }}" method="post" class="editor">
        @csrf
        <div class="editor-body">
            <input class="editor-title" type="text" name="title" placeholder="タイトルなど" value="{{old('title', $reading->title)}}" required>
            <div class="editor-content">
                <textarea class="editor-content-body" name="contents" placeholder="感想" value="{{old('contents', $reading->contents)}}" required></textarea>
            </div>
